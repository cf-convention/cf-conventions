...
Data variables that have been quantized must also record the specific parameter value used in the quantization algorithm.
...
----
  variables:
    char quantization_info ;
      ...
      quantization_info:implementation = "NCO version 5.2.5-alpha01" ;
