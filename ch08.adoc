...
The variables referenced by the **`__interpolation_coefficients__`** attribute must contain numeric data, and the variables referenced by the **`__interpolation_flags__`** attribute contain status flag attributes (<<flags>>).
