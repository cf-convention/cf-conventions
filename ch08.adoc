...
be separately associated with the corresponding interpolation variable
according to which corresponding tie interpolation dimension they
span, even if that interpolation variable is the same in each
