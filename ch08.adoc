...
Note that an interpolation zone dimension size is, by definition, the same as the size of the corresponding tie point interpolation dimension, minus the number of interpolation areas.
