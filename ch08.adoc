...
### Anders: what happens if the tie point coordinates are decreasing in index space - does -0.5 still mean offset to the "left", or is it to the "right" in this case??
