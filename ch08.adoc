...
an interpolation parameter variable depends on which, if any, of its
dimensions are tie point interpolation dimensions, and which are
interpolation zone dimensions:
