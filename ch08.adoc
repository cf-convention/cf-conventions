...
The presence of non-interpolated dimensions in the tie point variable
...
dimension in the **`tie_point_mapping`** attribute. For instance,
...
interpolation zones, as is the case in <<example-VIIRS>>.
