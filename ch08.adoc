...
Note that an interpolation dimension size is the same as the number of tie point coordinates along the corresponding interpolation dimension, minus the number of interpolation areas.
