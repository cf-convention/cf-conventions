...
The netCDF data types **`string`**, **`char`**, **`byte`**, **`unsigned byte`**, **`short`**, **`unsigned short`**,
**`int`**, **`unsigned int`**, **`int64`**, **`unsigned int64`**,
...
When the phrases "an integer type" or "any integer type" are used in this document,
