...
Note that the missing values indicated by the aggregation variable apply to the aggregated data once it has been created, and not to the individual fragments, which may define their own missing data. It is up to the creator of the aggregation variable to ensure that none of the aggregation variable's missing values coincide with non-missing values in the fragments.
...
A fragment that contains wholly missing data is specified with any missing value indicated by the aggregation variable.
