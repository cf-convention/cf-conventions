...
The CF conventions do not currently offer guidance to dataset creators on how to decide if two or more fragments can be aggregated.
...
If the aggregation file is moved to another location then the fragment files must also be moved to preserve their relative locations.
