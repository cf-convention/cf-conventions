...
See <<example-L.1, Example L.1>> and <<example-L.5, Example L.5>>.
...
See <<example-L.6, Example L.6>>, which uses an ancillary aggregation variable to make global attributes from the fragment datasets available in the aggregation file.
