...
The components of a netCDF file are described in section 2 of the NUG [<<nug,NUG>>] . In this section we describe conventions associated with filenames and the basic components of a netCDF file. We also introduce new attributes for describing the contents of a file.
