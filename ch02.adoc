...
* When, and only when, the fragment's data has been provided as its unique value (as opposed to being defined from a fragment dataset), broadcasting that value across the fragment's canonical shape.
