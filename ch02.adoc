...
This may be used when it is known that multiple fragment file locations are possible, but it is not known in advance which of them might exist at any given time.
