...
. Consistent sets of values for **`standard_name `**  and **`computed_standard_name `**
needed in defining the ocean sigma coordinate, the ocean s-coordinate, the ocean_sigma over
z coordinate, and the ocean double sigma coordinate. 
[cols="1",caption="Table D.1. "]
|===============

[options="header",cols="2,8,4,12",caption="Table D.1. "]
|===============
|{set:cellbgcolor!}
| option
...
| 1| altitude| eta| sea_surface_height_above_geoid

| 1| altitude| depth| sea_floor_depth_below_geoid

| 2| height_above_geopotential_datum| zlev| height_above_geopotential_datum

| 2| height_above_geopotential_datum| eta| sea_surface_height_above_geopotential_datum

| 2| height_above_geopotential_datum| depth| sea_floor_depth_below_geopotentiall_datum

| 3| height_above_reference_ellipsoid| zlev| height_above_reference_ellipsoid

| 3| height_above_reference_ellipsoid| eta| sea_surface_height_above_reference_ellipsoid

| 3| height_above_reference_ellipsoid| depth| sea_floor_depth_below_reference_ellipsoid

| 4| height_above_mean_sea_level| zlev| height_above_mean_sea_level

| 4| height_above_mean_sea_level| eta| sea_surface_height_above_mean_sea_level

| 4| height_above_mean_sea_level| depth| sea_floor_depth_below_mean_sea_level
