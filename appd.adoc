...
To ensure that the operands of the trigonometrical functions are
dimensionless, `a` must identical units.
...
To ensure that the operands of the trigonometrical functions are
dimensionless, `z1`, `z2`, and `a` must have identical units.
