...
| 10
| If auxiliary coordinate variables have been reconstituted, then add a **`coordinates`** attribute to the data variable, if not already present, and add to the attribute the list of the names of the reconstituted auxiliary coordinate variables.
| <<coordinate-system>>
