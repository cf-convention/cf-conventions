...
* In case (2) of the requirements for this section, the norm coordinate variable is recommended not to have any of the <<attribute-appendix>> except for **`cell_methods`** and **`coordinates`**.
