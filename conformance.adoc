...
* In its section 7.2, change "that must exist in the file" to "that must either exist 
in the file or be named by the **`external_variables`** attribute".
...
=== 4.3.2 Parameterized Vertical Coordinate
