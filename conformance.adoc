...
* When either the default mixed Gregorian/Julian calendar, or **`julian`** calendar,
are in use, the reference date/time must not be earlier than 1-1-1 0:0:0.
...
* When either the default mixed Gregorian/Julian calendar, or **`julian`** calendar,
are in use, encoded time coordinates must not be earlier than 1-1-1 0:0:0.
