...
In the first two recommendations, when we refer to a UDUNITS unit of time e.g. **`year`**, we mean the string given or any which is equivalent to it in UDUNITS e.g. **`yr`**, optionally with one of the prefixes of Table 3.1.
