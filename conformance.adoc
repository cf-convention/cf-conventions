...
* In case (2) of the requirements for this section, the norm coordinate variable is recommended not to have any of the Appendix A attributes except for **`cell_methods`**, **`coordinates`** and **`_FillValue`**.
