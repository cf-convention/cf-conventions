...
* Only floating-point type data variables can be quantized. Quantized variables must have and are identified by having a string-valued attribute named **`quantization`**.
...
* Data variables that appear in **`formula_terms`** attributes should not be quantized and therefore should not have a **`quantization`** attribute.
