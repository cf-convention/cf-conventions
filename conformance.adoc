...
In particular: it must include the date; the time zone offset must not be included unless the time is included; there must be a space between the time and the time zone offset if both are included and the latter begins with a numeral.
