...
| A
| <<aggregated-data>>
| Records the aggregation instructions that define how to create an aggregation variable's aggregated data.

| **`aggregated_dimensions`**
| S
| A
| <<aggregated-dimensions>>
| Identifies the dimensions of an aggregation variable's aggregated data.
