...
| S
| C, D
| <<parametric-vertical-coordinate>>, <<external-file-uncertainty>>
| Indicates the standard name, from the standard name table, of the computed vertical coordinate values or uncertainty values computed according to the formula in the definition.
...
| Formula used to calculate values.

| **`formula_terms`**
| S
| C
| <<parametric-vertical-coordinate>>, <<computed-uncertainty>>
