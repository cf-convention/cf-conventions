...
_Z_ is _not_ a time zone name or acronym; it is an interval of time.

The default for time zone offset _Z_ is zero, which may also be explicitly indicated in any of the numeric formats for _Z_ defined below, or by the letter `Z`, sometimes referred to as "Zulu Time".
