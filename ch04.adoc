...
There is a special meaning for year zero in the real-world calendar, that is not recommended for current work.  See <<climatological-statistics>>.  This is an exception to the prohibition of year zero for certain calendars.
