...
Leap seconds are adjustments made at irregular and unpredictable intervals in Coordinated Universal Time (UTC), the international basis of civil timekeeping in the real world.
...
A minute would contain 59 seconds if it included a negative leap second, but none have been introduced up to now.
