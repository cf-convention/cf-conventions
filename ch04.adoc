...
| **`standard`** | 365/366 | usual | Julian/Gregorian | unknown | 0001-01-01 | +&#x221E; | no*
| **`julian`** | 365/366 | usual | Julian | no | 0001-01-01 | +&#x221E; | no*
...
+
__The **`standard`** calendar has been used for both observational data and model-generated data with real-world datetimes.
When using data written with the **`standard`** calendar for dates since 1972, you should regard datetimes and time coordinates as uncertain by a number of seconds (but less than a minute), because leap seconds may or may not have been taken into account.
See <<appendix-leap-seconds>> for details.
...
**`utc`**:: A calendar with the Gregorian rule for leap years, and __with leap seconds__ prescribed by UTC.
