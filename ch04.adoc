...
* &pm;__n__:__nn__ or &pm;__nn__:__nn__, the hour and minute, separated by a colon **`:`**, where the hour is one or two digits, and the minute is two digits, padded with leading zeroes if necessary e.g. **-10:00`**, **`-3:30`**, **`+5:30`**, **`+12:45`**.
