...
* if you are using an existing observational dataset for dates since 1972 with time coordinates in the **`standard`**, **`proleptic_gregorian`** or **`utc`** calendar, which treat them differently.
...
If the time coordinates identify real-world instants from 1972 onwards, they represent UTC datetimes.
