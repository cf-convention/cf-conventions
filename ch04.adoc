...
The difference between the two datetimes (**`tai`** minus **`utc`**) for a given instant of time is 10 seconds plus the net number of leap seconds introduced since the instant with the datetime 1972-01-10 in the **`tai`** calendar, when the current definition of UTC came into force.
This instant has the datetime 1972-01-01 00:00:00 in the **`utc`** calendar.
...
| **`standard`** | 365/366 | Gregorian | Julian/Gregorian | unknown | 0001-01-01 | +&#x221E; | no (climatology)
