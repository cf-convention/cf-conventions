...
This section first gives an overview of CF calendars, then describes the calendar corresponding to each of the possible values for the **`calendar`** attribute; this information is summarised in <<table-calendars, Table 4.1>> at the end of the section.
