...
| **`standard`** | 365/366 | usual | Julian/Gregorian | unknown | 0001-01-01 | +&#x221E; | no (climatology)
| **`julian`** | 365/366 | usual | Julian | no | 0001-01-01 | +&#x221E; | no (climatology)
| **`proleptic_gregorian`** | 365/366 | usual | Gregorian | no | -&#x221E; | +&#x221E; | yes
| **`no_leap`**/**`365_day`** | 365 | usual | never | no | -&#x221E; | +&#x221E; | yes
| **`all_leap`**/**`366_day`** | 366 | usual | every year | no | -&#x221E; | +&#x221E; | yes
| **`360_day`** | 360 | 12 x 30 days | never | no | -&#x221E; | +&#x221E; | yes
| **`utc`** | 365/366 | usual | Gregorian | yes | 1972-01-01 | present day | no
...
The lengths of the months defined by the Gregorian calendar are used in all calendars except **`360_day`**, **`none`** (see <<none-calendar>>) and explicitly defined calendars (see <<explicit-calendar>>).
...
**`utc`**:: A calendar with the Gregorian rule for leap years, and __with__ leap seconds prescribed by UTC.
...
**`tai`**:: A calendar with the Gregorian rule for leap years and __without__ leap seconds.
This calendar is based on International Atomic Time (TAI), which began on 1958-01-01 0:0:0.
