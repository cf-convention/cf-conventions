...
There is a special meaning for year zero in the real-world calendar, that is not recommended for current work.  See <<climatological-statistics>>.  This is an exception to the following prohibition of year zero in certain calendars.
