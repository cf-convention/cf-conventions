...
The field construct consists of a data array, a domain construct
defining the domain of the data, ancillary metadata defined over the
same domain, metadata to describe how the cell values represent the
...
The domain construct describes measurement locations and cell
properties. It corresponds to a CF-netCDF domain variable, or the
domain defined collectively by various data variable attributes. The
domain construct is the only construct that may also exist
independently of a field construct.

The domain construct consists of the following metadata constructs
required to define a domain:
