...
The field construct consists of a data array, metadata defining the
domain that provides measurement locations and cell properties for the
data, ancillary metadata defined over the same domain, metadata to
...
of the field which is mandatory is the data array.
