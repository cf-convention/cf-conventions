...
If a polygonal cell is composed of multiple parts, an individual
...
part when cells are comprised of multipart lines, multipart polygons,
and polygons with holes. When a geometry container variable is not
