...
.Pending
. Added <<compression-by-coordinate-sampling, Section 8.3, "Lossy Compression by Coordinate Sampling">>.
. Updated definitions in chapter 1 and Appendix A
. Added <<appendix-coordinate-sampling, Appendix J, "Coordinate Sampling">>.
