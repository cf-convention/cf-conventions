...
.22 July 2020
. link:$$https://github.com/cf-convention/cf-conventions/issues/193$$[Issue #193]: Figures to clarify the order of the verties of cell bounds
...
. link:$$https://github.com/cf-convention/cf-conventions/issues/288$$[Issue #288]: Remove unecessary line from table in section 9.3.1
