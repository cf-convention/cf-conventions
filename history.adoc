...
. Ticket 104, Changed the first and second sentence and added a fourth sentence in Section 5.7 "Scalar Coordinate Variables".  
In section 6.1 "Labels" Added a new sentence to bottom of second paragraph.

. Ticket #70, Modify text in Section 5.6.  Changed Example 5.10. British National Grid
