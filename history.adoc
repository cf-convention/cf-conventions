...
.1 April 2021
. link:$$https://github.com/cf-convention/cf-conventions/issues/298$$[Issue #298]:
In calendars `standard` and `julian`, prohibit year zero and negative years.
. In calendars `proleptic_gregorian`, `365_day`, `366_day`, and `360_day`,
year zero and negative years are explicitly included.
