...
.20 May 2020
. link:$$https://github.com/cf-convention/cf-conventions/issues/159$$[Issue #159]: Incorporate the CF data model into the conventions
...
.24 August 2021
. link:$$https://github.com/cf-convention/cf-conventions/issues/327$$[Issue #327]: Lossy compression by coordinate subsampling
