...
* {issues}367{Issue #367}: Remove the AMIP and GRIB columns from the standard name table format defined by Appendix B. These equivalences have not been updated for many years, and it would be better to maintain a mapping elsewhere.
