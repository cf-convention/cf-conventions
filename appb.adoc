...
----
  ...
  <conventions_string>Conventions string here ... </conventions_string> 
...
where the "Conventions string" is  composed of the fixed string **`CF-StdNameTable-`** immediately followed by the version number.
...
----
  ...
  <standard_name_table>
    ...
    <conventions_string>CF-StdNameTable-83</conventions_string>
