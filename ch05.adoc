...
instance). The `dimensions` attribute defines the scope of the domain
in the same way that that role is fulfilled by the dimensions of a
data variable. The value of the `dimensions` attribute is a blank
