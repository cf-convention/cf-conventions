...
variables:
  ...
  double lat(y, x) ;
       ...
       lat:units = “degrees_north”;
  double lon(y, x) ;
       Ion:standard_name = “longitude”     
       Ion:units = “degrees_east”
  float temp(z, y, x) ;
    temp:standard_name = "sir_temperature" ;
    temp:units = "K" ;
    temp:coordinates = "lat lon" ;
    temp:grid_mapping = "crsOSGB" : x y crsWGS84:  lat Ion”;
float pres(z, y, x);
   temp:standard_name = “air_pressure”;
   temp:units = ”Pa”;
   temp:coordinates = “lat Ion”;
   temp:grid_mapping = “crsOSGB: x y crsWGS84: lat Ion”;
int crsOSGB;
