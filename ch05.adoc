...
variables to/from OGC Well-Known Text (WKT) format is shown in Examples 5.9 and 5.10 below and
described in detail in https://cf-pcmdi.llnl.gov/trac/wiki/Cf2CrsWkt.
...
shown in http://cf-pcmdi.llnl.gov/trac/wiki/Cf2CrsWkt[1] should be preferred; these are derived from
the OGP/EPSG registry of geodetic parameters, which is considered to represent the definitive
