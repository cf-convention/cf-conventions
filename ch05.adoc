...
When a data variable is representative of cells of non-zero size, and the coordinate variables are not longitude and latitude, __bounds__ variables should be provided for vertices of the cell boundaries in the eastings and northings of the grid (see  <<cell-boundaries>>).
