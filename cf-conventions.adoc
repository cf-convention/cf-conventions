...
Eaton, B., Gregory, J., Drach, B., Taylor, K., Hankin, S. et al. (2023). NetCDF Climate and Forecast (CF) Metadata Conventions ({current-version-as-attribute}). CF Community. https://doi.org/10.5072/zenodo.XXXXXX
endif::[]
