...
| I
| MT
| Specify the position of the dimension used to index the nodes in the edge connectivity variable.
...
| I
| MT
| Specify the position of the dimension used to index the edges in the face connectivity variable.
...
| I
| MT
| Specify the position of the dimension used to index the faces in the volume connectivity variable.
