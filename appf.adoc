...
// Except as marked, all work for asciidoctor.  None work for asciidoctor-pdf.
   For testing, several methods for implementing less-than-or-equals: +
     Domain: **`-90.0 &#x2264; latitude_of_projection_origin &#x2264; 90.0`** +
//doesn't work for asciidoctor     Domain: **`-90.0 &#2264; latitude_of_projection_origin &#2264; 90.0`** +
//     Domain: **`-90.0 &le; latitude_of_projection_origin &le; 90.0`** +
//     Domain: **`-90.0 &leq; latitude_of_projection_origin &leq; 90.0`** +
//     Domain: **`-90.0 +++<u>&le;</u>+++ latitude_of_projection_origin +++<u>&le;</u>+++ 90.0`** +
//     Domain: **`-90.0 < = latitude_of_projection_origin < = 90.0`** +
//     Domain: **`-90.0 \<= latitude_of_projection_origin \<= 90.0`** +
     Domain: -90.0 \<= latitude_of_projection_origin \<= 90.0 +
