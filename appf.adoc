...
The coordinate can be any kind of coordinate, apart from coordinate variables or auxiliary coordinates, especially a tie-point coordinate can be used to encode contiguous blocks in index space in a compact way.
