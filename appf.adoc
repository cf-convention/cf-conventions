...
and
link:$$https://geotiff.maptools.org/proj_list/albers_equal_area_conic.html$$[https://geotiff.maptools.org/proj_list/albers_equal_area_conic.html].
...
__Notes:__:: Notes on using the **`PROJ`** software package for computing the mapping may be found at
link:$$https://geotiff.maptools.org/proj_list/azimuthal_equidistant.html$$[https://geotiff.maptools.org/proj_list/azimuthal_equidistant.html]
and
...
and
link:$$https://geotiff.maptools.org/proj_list/lambert_azimuthal_equal_area.html$$[https://geotiff.maptools.org/proj_list/lambert_azimuthal_equal_area.html]
...
and
link:$$https://geotiff.maptools.org/proj_list/lambert_conic_conformal_1sp.html$$[https://geotiff.maptools.org/proj_list/lambert_conic_conformal_1sp.html]
("Lambert Conic Conformal (1SP)" or EPSG 9801) or
link:$$https://geotiff.maptools.org/proj_list/lambert_conic_conformal_2sp.html$$[https://geotiff.maptools.org/proj_list/lambert_conic_conformal_2sp.html]
...
and
link:$$https://geotiff.maptools.org/proj_list/cylindrical_equal_area.html$$[https://geotiff.maptools.org/proj_list/cylindrical_equal_area.html]
...
and
link:$$https://geotiff.maptools.org/proj_list/mercator_1sp.html$$[https://geotiff.maptools.org/proj_list/mercator_1sp.html]
("Mercator (1SP)" or EPSG 9804)
or
link:$$https://geotiff.maptools.org/proj_list/mercator_2sp.html$$[https://geotiff.maptools.org/proj_list/mercator_2sp.html]
...
and
link:$$https://geotiff.maptools.org/proj_list/oblique_mercator.html$$[https://geotiff.maptools.org/proj_list/oblique_mercator.html].
...
and
link:$$https://geotiff.maptools.org/proj_list/orthographic.html$$[https://geotiff.maptools.org/proj_list/orthographic.html]
...
and
link:$$https://geotiff.maptools.org/proj_list/polar_stereographic.html$$[https://geotiff.maptools.org/proj_list/polar_stereographic.html].
...
and
link:$$https://geotiff.maptools.org/proj_list/sinusoidal.html$$[https://geotiff.maptools.org/proj_list/sinusoidal.html].
...
and
link:$$https://geotiff.maptools.org/proj_list/stereographic.html$$[https://geotiff.maptools.org/proj_list/stereographic.html].
...
and
link:$$https://geotiff.maptools.org/proj_list/transverse_mercator.html$$[https://geotiff.maptools.org/proj_list/transverse_mercator.html].
