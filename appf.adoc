...
__Map parameters:__::
* **`level`** - This parameter defines zoom level.  
...
The grid resolution is controlled by the zoom level parameter **`level`**, starting from 0.  See <<GHB05>> for the calculation of center coordinates and cell boundaries coordinates. 


__Notes:__::
At a given zoom level, the total number of cells corresponds to 12 \times 4^{\text{zoom\_level}}
