...
* **`latitude_dimension`** - The name of both a one-dimensional variable, which contains the latitude coordinates of the latitude lines, and of its single dimension, which specifies the number of latitude lines _N_, where _N_ must be even because these grids do not have points at the poles and equator.
