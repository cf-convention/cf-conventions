...
For one-dimensional coordinate variables, the size of the vertex dimension is always two.
For multidimensional coordinate variables, its size is always greater than two.
