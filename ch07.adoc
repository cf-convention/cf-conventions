...
In the remainder of this section and the following two (<<anomalies-norm-data>> and <<anomalies-norm-metadata>>), we describe more general conventions for anomalies that can handle more complex use-cases.
...
Any norm axis dimensions must be included among the dimensions of the anomaly data variable as well being dimensions of the norm data variable; likewise, any scalar norm coordinate variables must be named in the **`coordinates`** attribute of the anomaly data variable as well as the norm data variable.
