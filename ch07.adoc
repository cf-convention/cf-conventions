...
Example 7.15 shows how the **`cell_methods`** of the norm data variable clarifies the definition of the climatological statistic.
...
In these examples, the climatological time coordinate variable has just one element, for climatological July.
