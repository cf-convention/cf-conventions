...
the **`grid_mapping`** attribute on the geometry container variable names the
same variable as the **`grid_mapping`** attribute on the associated data
variable. If a different grid mapping variable is named, then the provided
