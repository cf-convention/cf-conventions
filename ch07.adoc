...
Cell portions are referred to by means of standardised area_type strings (<<standard-name>>), maintained in the CF Area Type Table link:$$https://cfconventions.org/Data/area-type-table/current/build/area-type-table.html$$[https://cfconventions.org/Data/area-type-table/current/build/area-type-table.html], using one of two conventions.
