...
Pixels in a raster are rectangular, all of the same size, and arranged in a logically rectangular array with their nominal point locations at their centers.
By contrast, two-dimensional cells in a CF field do not necessarily satisfy any of those conditions, though they commonly do.
