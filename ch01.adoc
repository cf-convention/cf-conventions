...
Files using this version of the CF Conventions must set the NUG defined attribute **`Conventions`** to contain the string value "**`CF-{attribute-version}`**" to identify datasets that conform to these conventions.
