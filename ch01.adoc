...
Files using the CF Conventions must set the NUG defined attribute **`Conventions`** to the string value "**`CF-1.8`**" to identify datasets that conform to these conventions.
