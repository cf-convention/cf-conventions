...
lossy compression variable:: A variable used as a container for attributes that define a specific lossy compression algorithm. The type of the variable is arbitrary since it contains no data.
