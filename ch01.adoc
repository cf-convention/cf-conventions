...
aggregation variable:: A variable containing no data, but which enables the formation its data (i.e. its aggregated data) via the combination of data arrays found in one or more fragments (see <<aggregation-variables>>).
