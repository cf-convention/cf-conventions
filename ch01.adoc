...
local apex group:: The nearest (to a referring group) ancestor group in which a dimension underlying an out-of-group coordinate is defined. The word "apex" refers to position of this group at the upper vertex of the triangle of groups formed by it, the referring group, and the group where a coordinate is located. 
